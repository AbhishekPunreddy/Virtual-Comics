...
leftBtn.addEventListener('click', () => {
  window.localStorage.setItem("story2_controls_response","Person1");
  getValues()
})
rightBtn.addEventListener('click', () => {
  window.localStorage.setItem("story2_controls_response","Person2");
  getValues()
})
const getValues =() =>{
  endTime = new Date();
  ...
  window.localStorage.setItem("story2_controls",timeElasped);
}