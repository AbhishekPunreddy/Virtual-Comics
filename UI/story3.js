...
leftBtn.addEventListener('click', () => {
  window.localStorage.setItem("story3_experimental_response","The guy on the left");
  getValues()
})
rightBtn.addEventListener('click', () => {
  window.localStorage.setItem("story3_experimental_response","The guy on the right");
  getValues()
})
const getValues =() =>{
  endTime = new Date();
  ...
  window.localStorage.setItem("story3",timeElasped);
  ...
  link.setAttribute('download', 'Experimental_Condition_Responses.txt');
